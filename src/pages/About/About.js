            ...
            <div id="about" className="about-me-container py-5 container-fluid">
                ...
                <div className="row pb-5">
                    ...
                    <div className="col-sm-12 pb-5 col-lg-8 about-me-bio mt-3 text-white pl-4 pr-4"
                        ...
                        <h4 data-aos="fade-left" className="mt-0 text-success">Front-End Web Developer</h4>
                        <p  data-aos="fade-left">I am a MERN stack developer. I have been building Responsive Web Design and
                        ...
                        <p data-aos="fade-left" ><b>phone: </b> 01985525743</p>
